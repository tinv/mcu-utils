...
public:
    ...
    MOCK_METHOD(int, file_write, (const char *fname, const uint8_t *buf, const size_t size), (override));
    MOCK_METHOD(int, file_read, (const char *fname, uint8_t *buf, const size_t size), (override));
